...
pub struct AppSettings {
    ...
    pub about_window_width: Option<f64>,
    pub about_window_height: Option<f64>,
    pub about_window_x: Option<i32>,
    pub about_window_y: Option<i32>,
...
impl Default for AppSettings {
    fn default() -> Self {
        Self {
            ...
            about_window_width: None,
            about_window_height: None,
            about_window_x: None,
            about_window_y: None,
