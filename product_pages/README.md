# CyberPaste GitHub Pages

This directory contains the GitHub Pages website for CyberPaste, including all pages required for Mac App Store submission.
...
All pages use pure HTML/CSS with no build process required. Simply edit the HTML files and push to GitHub. Changes will be live within a few minutes.
...
The website content is part of the CyberPaste project and is licensed under GPL-3.0.
