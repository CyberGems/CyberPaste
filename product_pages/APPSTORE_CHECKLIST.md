# Mac App Store Submission Checklist for CyberPaste
...
- [ ] Explain Accessibility permission usage:
  - "CyberPaste requests Accessibility permission to enable the optional auto-paste feature, which simulates keyboard input (Cmd+V) to paste clipboard content into other applications. This permission is optional and not required to use the app."
